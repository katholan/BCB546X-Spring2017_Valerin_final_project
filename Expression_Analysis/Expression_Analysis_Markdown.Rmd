...
#breaks sets how many colors in your gradient and what values get assigned what colors
breaks=seq(0, 100, by=1)
#defines color palette.  Since there aren't negative values, only used 2 colors 
my_col <- colorpanel(n=length(breaks)-1,low="gray75",high="black")

#can add dendrogram to show clustering of genes or samples, but since there are only 2 samples doesn't make sense to show that cluster
